...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://dashboard.heroku.com/new?template=https://github.com/rarity100022/clonebot-alpha-for-mn-300tb)
...
- https://github.com/xyou365/AutoRclone (for `add_to_team_drive.py` and `gen_sa_accounts.py`)
